...
export interface ITableQuadrantStackProps extends Props {
     ...
     * May return undefined if the table is not attached to the DOM yet.
     */
    columnHeaderRenderer?: (refHandler: IRef<HTMLDivElement>, resizeHandler: (verticalGuides: number[] | null) => void, reorderingHandler: (oldIndex: number, newIndex: number, length: number) => void, showFrozenColumnsOnly?: boolean) => JSX.Element | undefined;
    /**
     ...
     * May return undefined if the table is not attached to the DOM yet.
     */
    rowHeaderRenderer?: (refHandler: IRef<HTMLDivElement>, resizeHandler: (verticalGuides: number[] | null) => void, reorderingHandler: (oldIndex: number, newIndex: number, length: number) => void, showFrozenRowsOnly?: boolean) => JSX.Element | undefined;
    /**
