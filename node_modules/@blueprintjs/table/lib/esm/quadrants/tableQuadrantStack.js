...
var TableQuadrantStack = /** @class */ (function (_super) {
    ...
    function TableQuadrantStack(props, context) {
        ...
        _this.maybeSetQuadrantSizes = function (width, height) {
            _this.maybesSetQuadrantSize(QuadrantType.LEFT, "width", Utils.clamp(width, MIN_ROW_HEADER_WIDTH));
            _this.maybesSetQuadrantSize(QuadrantType.TOP, "height", Utils.clamp(height, MIN_COL_HEADER_HEIGHT));
            _this.maybesSetQuadrantSize(QuadrantType.TOP_LEFT, "width", Utils.clamp(width, MIN_ROW_HEADER_WIDTH));
            _this.maybesSetQuadrantSize(QuadrantType.TOP_LEFT, "height", Utils.clamp(height, MIN_COL_HEADER_HEIGHT));
        };
        ...
        _this.maybesSetQuadrantRowHeaderSizes = function (width) {
            var clampedWidth = Utils.clamp(width, MIN_ROW_HEADER_WIDTH);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.MAIN, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.TOP, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.LEFT, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(QuadrantType.TOP_LEFT, clampedWidth);
        };
        ...
        _this.maybeSetQuadrantMenuElementSizes = function (width, height) {
            var clampedWidth = Utils.clamp(width, MIN_ROW_HEADER_WIDTH);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.MAIN, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.TOP, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.LEFT, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(QuadrantType.TOP_LEFT, clampedWidth, height);
        };
