...
export class Table2 extends AbstractComponent2 {
    ...
    constructor(props, context) {
        super(props, context);
        const { children, columnWidths, defaultRowHeight, defaultColumnWidth, enableRowHeader, numRows, rowHeights, selectedRegions = [], } = props;
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        const didColumnWidthsChange = this.props.columnWidths !== undefined &&
            !Utils.compareSparseArrays(this.props.columnWidths, prevState.columnWidths);
        const didRowHeightsChange = this.props.rowHeights !== undefined &&
