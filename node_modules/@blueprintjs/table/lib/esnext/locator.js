...
export class Locator {
     ...
     */
    hasVerticalOverflow(columnHeaderHeight = Grid.MIN_COLUMN_HEADER_HEIGHT, viewportRect = this.getViewportRect()) {
     ...
     */
    hasHorizontalOverflow(rowHeaderWidth = Grid.MIN_ROW_HEADER_WIDTH, viewportRect = this.getViewportRect()) {
        if (this.grid === undefined) {
            return false;
        }
