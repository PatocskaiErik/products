...
var TableQuadrantStack = /** @class */ (function (_super) {
    ...
    function TableQuadrantStack(props, context) {
        ...
        _this.maybeSetQuadrantSizes = function (width, height) {
            _this.maybesSetQuadrantSize(tableQuadrant_1.QuadrantType.LEFT, "width", utils_1.Utils.clamp(width, MIN_ROW_HEADER_WIDTH));
            _this.maybesSetQuadrantSize(tableQuadrant_1.QuadrantType.TOP, "height", utils_1.Utils.clamp(height, MIN_COL_HEADER_HEIGHT));
            _this.maybesSetQuadrantSize(tableQuadrant_1.QuadrantType.TOP_LEFT, "width", utils_1.Utils.clamp(width, MIN_ROW_HEADER_WIDTH));
            _this.maybesSetQuadrantSize(tableQuadrant_1.QuadrantType.TOP_LEFT, "height", utils_1.Utils.clamp(height, MIN_COL_HEADER_HEIGHT));
        };
        ...
        _this.maybesSetQuadrantRowHeaderSizes = function (width) {
            var clampedWidth = utils_1.Utils.clamp(width, MIN_ROW_HEADER_WIDTH);
            _this.maybeSetQuadrantRowHeaderSize(tableQuadrant_1.QuadrantType.MAIN, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(tableQuadrant_1.QuadrantType.TOP, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(tableQuadrant_1.QuadrantType.LEFT, clampedWidth);
            _this.maybeSetQuadrantRowHeaderSize(tableQuadrant_1.QuadrantType.TOP_LEFT, clampedWidth);
        };
        ...
        _this.maybeSetQuadrantMenuElementSizes = function (width, height) {
            var clampedWidth = utils_1.Utils.clamp(width, MIN_ROW_HEADER_WIDTH);
            _this.maybeSetQuadrantMenuElementSize(tableQuadrant_1.QuadrantType.MAIN, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(tableQuadrant_1.QuadrantType.TOP, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(tableQuadrant_1.QuadrantType.LEFT, clampedWidth, height);
            _this.maybeSetQuadrantMenuElementSize(tableQuadrant_1.QuadrantType.TOP_LEFT, clampedWidth, height);
        };
    ...
    TableQuadrantStack.prototype.measureDesiredRowHeaderWidth = function () {
        ...
        if (mainRowHeader == null) {
            ...
            return utils_1.Utils.clamp(mainRowHeader.clientWidth, MIN_ROW_HEADER_WIDTH);
        }
    };
    /**
    ...
    TableQuadrantStack.prototype.measureDesiredColumnHeaderHeight = function () {
        ...
        return mainColumnHeader == null ? 0 : utils_1.Utils.clamp(mainColumnHeader.clientHeight, MIN_COL_HEADER_HEIGHT);
    };
