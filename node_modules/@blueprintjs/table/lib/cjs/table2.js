...
var Table2 = /** @class */ (function (_super) {
    ...
    function Table2(props, context) {
        ...
        _this.refHandlers = {
            ...
            columnHeader: function (ref) {
                ...
                if (ref != null) {
                    _this.columnHeaderHeight = ref.clientHeight;
                }
            },
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            var rowIndices = _this.grid.getRowIndicesInRect(viewportRect, hasVerticalOverflow ? false : enableGhostCells);
        ...
        var children = props.children, columnWidths = props.columnWidths, defaultRowHeight = props.defaultRowHeight, defaultColumnWidth = props.defaultColumnWidth, enableRowHeader = props.enableRowHeader, numRows = props.numRows, rowHeights = props.rowHeights, _a = props.selectedRegions, selectedRegions = _a === void 0 ? [] : _a;
    ...
    Table2.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        var didColumnWidthsChange = this.props.columnWidths !== undefined &&
            !utils_1.Utils.compareSparseArrays(this.props.columnWidths, prevState.columnWidths);
        var didRowHeightsChange = this.props.rowHeights !== undefined &&
            !utils_1.Utils.compareSparseArrays(this.props.rowHeights, prevState.rowHeights);
    ...
    Table2.prototype.shouldDisableVerticalScroll = function () {
        ...
        var areGhostRowsVisible = enableGhostCells && this.grid.isGhostIndex(rowIndices.rowIndexEnd - 1, 0);
    ...
    Table2.childContextTypes = context_1.columnInteractionBarContextTypes;
